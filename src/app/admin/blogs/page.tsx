      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Write and publish travel guides and articles.</p>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="p-12 text-center">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-1">No blog posts</h3>
            <p className="text-gray-500 text-sm">Start writing your first travel article.</p>
          </div>
        </div>
      </div>
    </div>

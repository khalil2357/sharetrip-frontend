    ...
    <div className="p-4 lg:p-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl font-black text-gray-900">Coupons & Promo Codes</h1>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="p-12 text-center">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-1">No active coupons</h3>
            <p className="text-gray-500 text-sm">Create a discount code to boost sales.</p>
          </div>
        </div>
      </div>
    </div>

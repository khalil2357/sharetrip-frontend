    ...
    <div className="p-4 lg:p-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl font-black text-gray-900">Visa Processing</h1>
            <p className="text-sm text-gray-500 mt-1">Manage visa applications and tracking.</p>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-500 text-sm">Visa applications will appear here.</p>
          </div>
        </div>
      </div>
    </div>
